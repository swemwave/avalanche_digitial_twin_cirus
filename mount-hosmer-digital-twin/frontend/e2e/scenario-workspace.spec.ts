...
const terrainOnlyResult = {
  ...
  validation: {
    ...
    component_field_validation: {
      release: { component_tested: "release", evidence_profile: "R", status: "unavailable", eligible_observation_count: 0, trusted_dataset_count: 0, reason: "No Profile R holdout." },
      conditional_runout: { component_tested: "conditional_runout", evidence_profile: "C", status: "unavailable", eligible_observation_count: 0, trusted_dataset_count: 0, reason: "No Profile C holdout." },
      end_to_end: { component_tested: "end_to_end", evidence_profile: "E", status: "unavailable", eligible_observation_count: 0, trusted_dataset_count: 0, reason: "No Profile E holdout." },
    },
    ...
    validation_data_contract: {
      status: "ingestion_scaffolding", schema_version: "test", legacy_read_versions: ["avycore-validation-dataset-v2"], normalized_projected_coordinates_required: true,
      ...
      trusted_dataset_count: 0, trusted_dataset_count_by_component: { release: 0, conditional_runout: 0, end_to_end: 0 },
      component_specific_evidence_profiles: true, positive_unlabelled_state_is_explicit: true,
